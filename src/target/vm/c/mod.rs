...
impl Target for VM {
    ...
    fn compile(&self, code: String, command: &mut Command, stdio: Stdio) -> Result<()> {
        ...
        child.wait().map_err(|e| Error::new(ErrorKind::Other, e))?; // wait for the child process to finish
